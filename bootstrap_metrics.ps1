...
# Download scripts
Invoke-WebRequest `
    -Uri "https://raw.githubusercontent.com/yajradevs/wazuh-python-monitoring/main/cpu_ram_metrics.py" `
    -OutFile "$BaseDir\cpu_ram_metrics.py"

Invoke-WebRequest `
    -Uri "https://raw.githubusercontent.com/yajradevs/wazuh-python-monitoring/main/internet_speed.py" `
